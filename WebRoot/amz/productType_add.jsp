...
<div class="am-u-md-6 am-u-sm-12 row-mb" style="width: 100%">
 ...
 <ol class="am-breadcrumb">
  ...
  <li><label  class="am-icon-angle-plus">添加类型</label></li>
</ol>	
 <div class="tpl-block ">
              ...
              <div class="am-g tpl-amazeui-form">
                  ...
                  <div class="am-u-sm-12 am-u-md-9">
                      <s:form id='role_add_formId' class="am-form am-form-horizontal" namespace="/manage" action="productType_add?state=add" method="post">
                          <div class="am-form-group">
                              <label for="user-name" class="am-u-sm-3 am-form-label">产品类型名 / productTypeName</label>
                              <div class="am-u-sm-9">
                                  <input name="productTypeName" type="text" placeholder="产品类型名 / productTypeName" onblur="isNum('productTypeNameError',this.value,'产品类型名');checkLen('productTypeNameError',this.value,1,5)"><span class="check" id="productTypeNameError">*</span>
						...
						<div align='center'>
                            ...
                            <a href="<%=path%>/manage/productType_list?manageId=<%=session.getAttribute("manageId")%>"><input type="button" value="取消" class="am-btn am-btn-primary"/></a>
                         </div>     
                      </s:form>
                  </div>
              </div>
