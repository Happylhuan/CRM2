...
<div class="am-u-md-6 am-u-sm-12 row-mb" style="width: 100%;overflow-y:hidden;">
 <div class="tpl-portlet">
 <div class="tpl-block ">
<div class="caption font-green bold">
					        <span class="am-icon-code"></span> LH117-${order.orderId}/订单详情
					 </div>  <hr>
                    <div style="text-align: center;"  class="am-g tpl-amazeui-form">
							  <div class="am-u-sm-12 am-u-md-9">
                                ...
                                <div class="am-form-group">
									...
									<div class="am-form-group">
                                    <label for="user-email" class="am-u-sm-3 am-form-label">创建时间 / orderTime</label>
                                    <label> <s:date format="yyyy-MM-dd hh:mm" name="order.orderTime"/></label>
                                	</div>
                                	<div class="am-form-group">
                                    <label for="user-email" class="am-u-sm-3 am-form-label">发货限期 / sendTime</label>
                                     <label> <s:date format="yyyy-MM-dd " name="order.sendTime"/></label>
                                	</div>
                                	<div class="am-form-group">
                                    ...
                                    <label> ${order.phoneNum}</label>
                                 	...
                                 	<div class="am-u-sm-9 am-u-sm-push-3">
                                      <a href="<%=path%>/user/order_list?userId=<%=session.getAttribute("userId")%>"><input type="button" value="返回" class="am-btn am-btn-primary"/></a>
                                    </div>
                                </div>
						 			</div>
