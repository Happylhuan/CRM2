...
<body data-type="chart">
 ...
 <div class="tpl-portlet">
				<ol class="am-breadcrumb">
				  <li><a href="<%=path%>/manage/main_list?manageId=${session.manageId}" onclick="changeParentTy('indexMenu');manageOpenul('product_ul','productStar3')" class="am-icon-home">首页</a></li>
				  <li><label  class="am-icon-angle-list">产品品牌列表</label></li>
				</ol>	
			<div class="tpl-block">
				<div class="am-g">
						...
						<div class="am-btn-toolbar">
							<div class="am-btn-group am-btn-group-xs">
								...
								<button type="button" 
									...
									<s:a style="color:black" href="amz/productBrand_add.jsp">
									<span class="am-icon-plus">
							    	</span>
							    	<s:param name="productBrand.manageId" value="manageId"></s:param>
									添加</s:a>
								</button>
								<button type="button" onclick="delall('<%=request.getContextPath()%>/manage/productBrand_dels?manageId=<%=session.getAttribute("manageId")%>&page.pageNo=<s:property value="page.pageNo"/>&productBrand.delEle=')"
					...
					<form action="<%=path%>/manage/productBrand_list">
						...
						<div class="am-u-sm-12 am-u-md-3">
							<div class="am-form-group">
								<select id="selectID" 
									...
									<option value="productBrandName">按产品品牌名</option>
								</select>
							</div>
						...
						<div class="am-u-sm-12">
								...
								<table
									...
									<s:if test="page.allRows == 0">
										...
										<s:iterator value="productBrands">
											<tr>
												<td><input name="checkId" type="checkbox" value='<s:property value="productBrandId"/>'></td>
												<td class="pro"><s:property value="productBrandName" /></td>
												<td class="pro">
												<s:a action="productBrand_del"
														namespace="/manage">
														<button
															class="am-btn am-btn-default am-round am-btn-xs am-text-danger am-hide-sm-only">
															<span class="am-icon-trash-o"></span> 删除
														</button>
														<s:param name="productBrand.productBrandId" value="productBrandId"></s:param>
         ...
         <div>	
			<h6 align="left" style="color:#03a9f4;">共[<s:property value="pageModel.page.totalPage"/>]页--共[<s:property value="pageModel.page.allRows"/>]条  &nbsp;&nbsp;</h6>
    		<div style="margin-left: 32%">
    		   <ul class="am-pagination tpl-pagination" >	
	    		   ...
	    		   <s:else>
		    		    <li class="am-active"><a href="<%=path %>/manage/productBrand_list.action?manageId=<%=session.getAttribute("manageId")%>&page.pageNo=1">首页</a></li>
			            &nbsp;&nbsp;&nbsp;
			            <li class="am-active"><a href="<%=path %>/manage/productBrand_list.action?manageId=<%=session.getAttribute("manageId")%>&page.pageNo=<s:property value="page.pageNo - 1"/>">«</a></li>
	    		   </s:else>
	    		   ...
	    		   <s:else>
		    		   	<li class="am-active"><a href="<%=path %>/manage/productBrand_list.action?manageId=<%=session.getAttribute("manageId")%>&page.pageNo=<s:property value="page.pageNo + 1"/>">»</a></li>
			            &nbsp;&nbsp;&nbsp;
			            <li class="am-active"> <a href="<%=path %>/manage/productBrand_list.action?manageId=<%=session.getAttribute("manageId")%>&page.pageNo=<s:property value="page.totalPage"/>">尾页</a></li>
	    		   </s:else>
	        	</ul>
	        </div>
        </div>
