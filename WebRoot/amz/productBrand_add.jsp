...
<div class="am-u-md-6 am-u-sm-12 row-mb" style="width: 100%">
 ...
 <ol class="am-breadcrumb">
  ...
  <li><a href="<%=path%>/manage/productBrand_list?manageId=${session.manageId}" onclick="changeParentTy('productMenu');manageOpenul('product_ul','productStar1')" class="am-icon-list">产品列表</a></li>
  <li><label  class="am-icon-angle-plus">添加品牌</label></li>
</ol>
 <div class="tpl-block ">
              ...
              <div class="am-g tpl-amazeui-form">
                  ...
                  <div class="am-u-sm-12 am-u-md-9">
                      <s:form id='role_add_formId' class="am-form am-form-horizontal" namespace="/manage" action="productBrand_add?state=add" method="post">
                          <div class="am-form-group">
                              <label for="user-name" class="am-u-sm-3 am-form-label">产品品牌名 / productBrandName</label>
                              <div class="am-u-sm-9">
                                  <input name="productBrandName" type="text" placeholder="产品品牌名 / productBrandName" onblur="isNum('productBrandNameError',this.value,'产品品牌名');checkLen('productBrandNameError',this.value,1,5)"><span class="check" id="productBrandNameError">*</span>
						...
						<div align='center'>
                            ...
                            <a href="<%=path%>/manage/productBrand_list?manageId=<%=session.getAttribute("manageId")%>"><input type="button" value="取消" class="am-btn am-btn-primary"/></a>
                         </div>     
                      </s:form>
                  </div>
              </div>
