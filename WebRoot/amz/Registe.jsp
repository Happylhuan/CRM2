  ...
  <div class="am-g myapp-login">
	<div class="myapp-login-logo-block  tpl-login-max">
		...
		<div class="am-u-sm-10 login-am-center">
			<form class="am-form" action="<%=path%>/amz/index.jsp">
				<fieldset>
					<div class="am-form-group">
						<input type="email" class="" id="doc-ipt-email-1" placeholder="输入账号/LoginName">
					</div>
					<div class="am-form-group">
						<input type="password" class="" id="doc-ipt-pwd-1" placeholder="密码/PassWord">
					</div>
